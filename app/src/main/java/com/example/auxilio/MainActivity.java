...
public class MainActivity extends AppCompatActivity {
    ...
    private Pessoa getData (){
        EditText cpf = (com.santalu.maskedittext.MaskEditText) findViewById(R.id.txtCpf);
        EditText nasc = (com.santalu.maskedittext.MaskEditText) findViewById(R.id.txtNasc);
        EditText renda = (com.santalu.maskedittext.MaskEditText) findViewById(R.id.txtRenda);
